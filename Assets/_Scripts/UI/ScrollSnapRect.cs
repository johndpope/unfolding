...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	public bool SnappingInitiated = false;
	public int CurrentPageNumber;
	public UnityEvent PageHasChanged;
	...
	public void InitiateSnapping(int pageCount) {
		...
		SnappingInitiated = true;
	}

    //------------------------------------------------------------------------
    void Update() {
		if(SnappingInitiated)
		{
    ...
    private void NextScreen() {
		...
		//CurrentPageNumber = _currentPage + 1;
    }
